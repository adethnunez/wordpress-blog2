<?php
    ...
    function blog_assets(){
        ...
        wp_enqueue_style('blog-slider', "https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.4/tiny-slider.css", 1.0 );

        wp_enqueue_script('blog-slider-style', "https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.4/min/tiny-slider.js", 1.0, [], true);
